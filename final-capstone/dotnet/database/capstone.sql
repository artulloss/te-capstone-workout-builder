...
VALUES ('Butt Kicks', 1, 'Standing tall, you are going to alternate, kicking yourself in the butt.',null,30, null, null, 2),
	   ('Dumbbell Runs', 1, 'Place a dumbbell (a towel or a water bottle) in front of you and run a circle around it. ',null, 30, null,null,2),
	   ...
	   ('Mountain Climbers', 1, 'Bring your knee up to your chest, jump the foot in front of the ground in front of you, bring it back to the start position and repeat on the opposite side. ',null,30, null,null,2),
       ...
       ('Suicides', 1, 'Imagine a line drawn in front of you, run to the end of the line, squat down and touch the ground. Then run back the other way and touch the other end of the line. Continue repeating this runs as fast as possible.',null,30, null,null,2),
...
--Back
	   ('TRX row', 2, 'Grab hold of the TRX handles and walk under them, forming a tabletop position with your arms extended. The more parallel your back is to the ground, the harder this exercise will be.
	     ...
	     Extend your arms and return to start, ensuring that your hips do not sag.',null, 120, 12,3,2),
       ...
       ('Renegade dumbbell row', 2, 'Assume a high plank position with each of your hands on a dumbbell. Your body should form a straight line from your head to your toes. Your core should be engaged throughout the movement.
         Row with your right arm, pulling your elbow toward the sky while keeping it close to your body, then returning the dumbbell to the ground. Ensure that your hips stay square to the ground. Repeat with your left arm.',null, 120, 20,3,2),
       ('Single-arm dumbbell row', 2, 'Position yourself on a bench so your left knee and shin are resting on it, as well as your left hand � this will be your support. Your right leg should be straight with your foot on the ground. Pick up the dumbbell with your right hand. Maintain a straight torso.
         ...
         Slowly lower back down to the start position.',null, 120, 12,3,2),
       ('Hyperextension', 2, 'Lie down on an exercise ball with your abdomen on the center of the ball. Press the balls of your feet into the ground to stay balanced.
		 ...
		 Pause for a moment when at the top, then slowly lower down.',null, 120, 12,3,2),
       ...
       ('Wide dumbbell row', 2, 'Hold a dumbbell in each hand and hinge at the waist, stopping when your upper body forms a 20-degree angle with the ground. Your palms should be facing your thighs, and your neck should remain neutral. Allow the dumbbells to hang down in front of you.
		 ...
		 Return to start and repeat',null, 120, 12,3,2),
	   ...
	   ('Quadruped dumbbell row', 2, 'Get on all fours with a dumbbell positioned in each hand. Ensure your back is straight, hands are directly below shoulders, and knees are directly below hips.
		 ...
		 Extend your arm, returning the dumbbell to the ground, and repeat on the left side.', null, 120, 12,3,2),
--Legs
	   ...
	   ('Calf-Raises', 3, 'Stand with your toes on a block and hold onto something sturdy for support. Raise your heels to come up on the balls of your feet, and then lower your heels until you feel a stretch in your calves. To increase difficulty, hold dumbbells in each hand at your sides.',null,180, 20, 3,2),
       ...
       ('Single-Leg Glute Bridge', 3, 'Lie on your back on the floor and bend both knees so that your feet rest on the floor close to your butt. Brace your abs and raise one leg up and bring the knee toward your chest. Drive the heel of the other foot into the floor. Bridge up until your body is in a straight line.',null,180, 10, 2,2),
	   ('Swiss Ball Leg Curl', 3, 'Brace your abs with heels on a stability ball. Raise your hips into the air, but keep your knees straight. From there, bend your knees and roll the ball back toward you. Keep your hips elevated throughout the set',null,180, 10, 2,2),
--arms
	   ...
	   ('Triceps Pressdown', 4, 'Start with a slight bend in your knees, stand facing a high-cable pulley with a pressdown bar attached to it. Your feet should be spread about shoulder-width apart. Grasp the pressdown bar with an overhand grip and hold the bar short at chest level with your elbows tight against your sides.
		 While keeping your elbows stationary, straighten your arms until they are fully extended. Pause at full arm extension and flex your triceps, then slowly return the bar to the start position.',45,300, 15, 3,2),
	   ...
	   ('Dumbbell Lateral Raise', 4, ' Stand with your feet about shoulder width apart while holding two dumbbells at your sides with neutral grips. Slowly raise the dumbbells up and out to your sides keeping your arms straight with a very slight bend in your elbows. When your arms reach just above parallel with the floor pause in t his position for a second before slowing lowering the dumbbells back to the start.',8,300, 12, 3,2),
       ('Standing Dumbbell Shrugs', 4, 'Take both weights in your hands. Shrug your shoulders up and back squeezing the traps as you come up.',40,300, 15, 3,2),
...
--abs
       ('Plank', 5, 'Your weight should be on the balls of your feet and your elbows, with your hands locked together in front. Keep your back and hips aligned so you form a straight line from your shoulders to your ankles. Brace your abdominals, and do not raise or lower those hips.',null,60, null, null,2),
