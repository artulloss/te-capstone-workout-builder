...
--abs
	   ...
	   ('L-Sit', 5,
         N'Sit with your palms on the floor by your sides. Point your fingers forwards and spread them out as if you are trying to grip the ground. Brace your legs, abs and glutes and lift yourself off the ground. Leaning your torso forwards slightly will help with your balance. Then hold that position.', null, 10, null, null,3),
	   ('Hollow Body Rock', 5,
